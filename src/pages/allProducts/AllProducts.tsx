  ...
  return (
    <div className="flex flex-col justify-center items-start">
      <div className="w-full flex justify-center">
        ...
        <div className="w-full lg:w-5/6 flex flex-wrap p-4 gap-x-10 gap-y-4 justify-start items-center h-screen overflow-y-scroll">
          <div className="flex flex-col justify-start items-start">
            <p className="p-4 text-2xl font-bold">All Products</p>
            <Breadcrumb
              className="px-4"
              items={[
                {
